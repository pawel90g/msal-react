...
export const msalConfig = {
    auth: {
        ...
        redirectUri: "https://polite-cliff-001fa8c03.2.azurestaticapps.net", // You must register this URI on Azure Portal/App Registration. Defaults to window.location.origin
        postLogoutRedirectUri: "https://polite-cliff-001fa8c03.2.azurestaticapps.net", // Indicates the page to navigate after logout.
